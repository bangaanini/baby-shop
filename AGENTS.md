...
- Workspace ID: `9b8369ea-eda7-4a6e-93f6-236d1c5c2b83`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/9b8369ea-eda7-4a6e-93f6-236d1c5c2b83.
...
2. `npx ngodingpakeai connect --workspace 9b8369ea-eda7-4a6e-93f6-236d1c5c2b83 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/9b8369ea-eda7-4a6e-93f6-236d1c5c2b83. Only pass on links the CLI actually printed — never assemble one from an id yourself.

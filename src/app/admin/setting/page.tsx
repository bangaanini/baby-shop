        ...
        if (data) {
          if (data.store) {
            setProfile((prev) => ({
              ...
              logo: data.store.logo || data.store.storeLogo || prev.logo || '',
              favicon: data.store.favicon || data.store.storeFavicon || prev.favicon || '',
              headerLogoDisplay: (data.store.headerLogoDisplay as 'both' | 'logo_only') || prev.headerLogoDisplay || 'both',
